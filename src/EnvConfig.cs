namespace tfd
{
    ...
    public static class EnvConfig
    {
        ...
        public static string tfd_ExceptionLogFilePath { get; private set; }
        public static string tfd_TrayMenuClearLogsText { get; private set; }
        public static string tfd_TrayMenuCopyLogsText { get; private set; }
        public static string tfd_TrayMenuExitText { get; private set; }
        public static int tfd_AppFormExStyle { get; private set; }
        public static FormWindowState tfd_AppFormWindowState { get; private set; }
        public static FormBorderStyle tfd_AppFormWindowBorderStyle { get; private set; }
        public static bool tfd_AppFormShowInTaskbar { get; private set; }
        public static double tfd_AppFormOpacity { get; private set; }
        public static int tfd_AppFormWidth { get; private set; }
        public static int tfd_AppFormHeight { get; private set; }
        ...
        public static void LoadVariables()
        {
            ...
            EnvConfig.tfd_ExceptionLogFilePath = EnvConfig.LoadEnvVar<string>(nameof(EnvConfig.tfd_ExceptionLogFilePath));
            EnvConfig.tfd_TrayMenuClearLogsText = EnvConfig.LoadEnvVar<string>(nameof(EnvConfig.tfd_TrayMenuClearLogsText));
            EnvConfig.tfd_TrayMenuCopyLogsText = EnvConfig.LoadEnvVar<string>(nameof(EnvConfig.tfd_TrayMenuCopyLogsText));
            EnvConfig.tfd_TrayMenuExitText = EnvConfig.LoadEnvVar<string>(nameof(EnvConfig.tfd_TrayMenuExitText));
            EnvConfig.tfd_AppFormExStyle = EnvConfig.LoadEnvVar<int>(nameof(EnvConfig.tfd_AppFormExStyle));
            EnvConfig.tfd_AppFormWindowState = (FormWindowState)EnvConfig.LoadEnvVar<long>(nameof(EnvConfig.tfd_AppFormWindowState));
            EnvConfig.tfd_AppFormWindowBorderStyle = (FormBorderStyle)EnvConfig.LoadEnvVar<long>(nameof(EnvConfig.tfd_AppFormWindowBorderStyle));
            EnvConfig.tfd_AppFormShowInTaskbar = EnvConfig.LoadEnvVar<bool>(nameof(EnvConfig.tfd_AppFormShowInTaskbar));
            EnvConfig.tfd_AppFormOpacity = EnvConfig.LoadEnvVar<double>(nameof(EnvConfig.tfd_AppFormOpacity));
            EnvConfig.tfd_AppFormWidth = EnvConfig.LoadEnvVar<int>(nameof(EnvConfig.tfd_AppFormWidth));
            EnvConfig.tfd_AppFormHeight = EnvConfig.LoadEnvVar<int>(nameof(EnvConfig.tfd_AppFormHeight));
            EnvConfig.tfd_IsProcessDPIAware = EnvConfig.LoadEnvVar<bool>(nameof(EnvConfig.tfd_IsProcessDPIAware));
            EnvConfig.tfd_EnableThreeFingerDrag = EnvConfig.LoadEnvVar<bool>(nameof(EnvConfig.tfd_EnableThreeFingerDrag));
